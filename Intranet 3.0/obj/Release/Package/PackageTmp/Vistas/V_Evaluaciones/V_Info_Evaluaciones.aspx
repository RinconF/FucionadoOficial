...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="pnl_tag">
        <p><i class="fas fa-tag"></i>Informe Evaluaciones</p>
    </div>

    <div style="text-align: center;">
        <!-- Mostrar el nombre de la Evaluación -->
        <h3><%= NombreEvaluacion %></h3> <!-- Aquí se muestra el nombre de la Evaluación -->

        
        <div class ="ContainerEn">
            <!-- Mensaje en caso de existencia de una Evaluación -->
        ...
        <asp:Panel ID="encuestaPanel" runat="server" Visible="false">
            ...
            <div id="legend" style="text-align: center; margin-top: 20px;">
                <div style="display: flex; justify-content: center; gap: 20px;">
                    <div>
                        ...
                        <span>Evaluaciones Finalizadas: <strong id="finalizadasCount"></strong></span>
                    </div>
                    <div>
                        <span style="display: inline-block; width: 16px; height: 16px; background-color: #e52e34; border-radius: 4px;"></span>
                        <span>Evaluaciones Pendientes: <strong id="pendientesCount"></strong></span>
                    </div>
                </div>
            </div>
            ...
            <div style="display: flex; justify-content: center; margin-top: 20px;">
                 ...
                 <asp:DropDownList ID="ddlTipoInforme" runat="server" CssClass="form-select"
