<%@ Page Title="Informe Evaluaciones" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="V_Info_Evaluaciones.aspx.cs" Inherits="Intranet_3._0.Vistas.V_Evaluaciones.V_Info_Evaluaciones" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="banner-container">
        <div class="pnl_tag">
            <p><i class="fas fa-clipboard-check"></i>Informe Evaluaciones</p>
        </div>
    </div>
            ...
            <div class="dashboard-grid-encuesta">
                ...
                <div class="chart-card-encuesta">
                    <div class="chart-header-encuesta">
                        ...
                        <p>Resumen actualizado de evaluaciones realizadas y pendientes</p>
                    </div>
            ...
            <div class="actions-card-encuesta">
                ...
                <div class="actions-controls">
                    ...
                    <div class="dropdown-wrapper">
                        <asp:DropDownList ID="ddlTipoInforme" runat="server" CssClass="form-select-encuesta">
    ...
    <script type="text/javascript">
        ...
        function confirmarDescargaInforme() {
            var ddl = document.getElementById('<%= ddlTipoInforme.ClientID %>');
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function resizeCanvas() {
                ...
                if (window.innerWidth <= 480) {
                    maxSize = Math.min(containerWidth - 20, 180);
                } else if (window.innerWidth <= 768) {
                    maxSize = Math.min(containerWidth - 30, 220);
                }
            ...
            // Log para debugging
            console.log('Gráfico de Evaluaciones renderizado:', {
                total: total,
