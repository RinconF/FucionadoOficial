...
<asp:Content ID="Content1" ContentPlaceHolderID="scripts_css" runat="server">
    <style>
        .section {
            display: grid;
            grid-template-areas: 'noticias social';
        ...
        @media only screen and (max-width: 550px) {
            .section__noticias {
                grid-template-columns: repeat(auto-fill, minmax(13rem, 23.8rem));
            }
        ...
        @media only screen and (max-width: 550px) {
            ...
            .modal_noticia .modal_noticia_content_ {
                width: 100%;
            }
        }
        ...
        .body-card-reci {
            ...
            .body-card-reci .card-title span {
        ...
        .modal_noticia .btn-close-noticia {
            position: absolute;
            top: 20px;
            right: 20px;
            padding: 10px 17px;
        ...
        .modal_noticia .modal_noticia_content_ {
            ...
            .modal_noticia .modal_noticia_content_ .body-card {
                margin: auto;
                max-width: 42rem;
                height: auto;
                max-height: 650px;
                ...
                .modal_noticia .modal_noticia_content_ .body-card .img-card .img {
                    border-radius: 5px;
                    width: 90%;
                    height: 400px;
                }
        ...
        @media screen and (max-width: 1366px) {
            #pnl-body-content-card .body-card {
                margin: 20px;
            }
        ...
        .body-card-more {
            ...
            .body-card-more:hover {
                box-shadow: none;
                opacity: .8;
            }

            .body-card-more:active {
                box-shadow: 2px 2px 3px inset rgba(0,0,0,.3);
            }
        ...
        @media only screen and (max-width: 733px) {
            ...
            .modal_noticia .modal_noticia_body .modal_noticia_content_ .body-card {
                padding: 10px 0;
                border-radius: 0px;
                max-width: 100%;
                min-height: 100vh;
        ...
        .opcion {
            ...
            .opcion input[type="radio"] {
                margin-right: 15px;
                accent-color: #3498db; /* Color del círculo del radio button */
                width: 18px;
                height: 18px;
            }
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="pnl_table">
        <div class="pnl_tag" style="border-radius: 5px 5px 0px 0px;">
            <p><i class="fas fa-tag"></i>Lo más reciente</p>
        </div>

        <div class="">
            <div class="body-content-card " id="pnl-body-content-card-reci"></div>
        </div>
    </section>
    ...
    <script defer>
        ...
        $(document).ready(function () {
            if (typeof popupManager !== "undefined") {
                ...
                console.error("popupManager no se cargó correctamente.");
            }
        });
