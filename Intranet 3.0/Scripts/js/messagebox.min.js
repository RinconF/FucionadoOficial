...
(function($, undefined){
    ...
    $.MessageBox = function(options){
        ...
        $(document.activeElement).not(".form-control").trigger("blur");
    ...
    function _CreateButton(mainClass, name, definition, instance){
        ...
        // Button
        var button = $("<button>", {
            class: mainClass + " btn btn-secondary",
        ...
        switch (type) {
            case "select":
                ...
                if (!defaultSelected) {
                    ...
                    select
                        .addClass("form-control_selectplaceholder")
                        .prop("selectedIndex", 0)
                        .one("change", function(){
                            select.find("option").css("color", "");
                            select.removeClass("form-control_selectplaceholder");
                        });
                }
                return select;
    ...
    function _GetInputsValues(messageBox){
        var names   = [];
        var values  = [];
        messageBox.find(".form-controls").find("input, select").each(function(){
            var input = $(this);
