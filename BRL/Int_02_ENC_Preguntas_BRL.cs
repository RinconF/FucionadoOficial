...
namespace BRL
{
    public class Int_02_ENC_Preguntas_BRL
    {
        ...
        {
            return new Int_02_ENC_PreguntasFactory().SelectTable(_Obj, Action);
        }
        public static int InsertOrUpdate(Int_01_ENC_Encuestas _Obj, int Action)
        {
            return new Int_02_ENC_PreguntasFactory().InsertOrUpdate(_Obj, Action);
        }
    }
}