...
namespace DAL
{
    public class Int_11_EVA_ResultadosFactory : FactoryBase
    {
        public Int_11_EVA_ResultadosFactory() { }
        ...
        {
            CreateCommand("Int_11_EVA_Resultados_SP", true);
            ...
            AddCmdParameter("@Resultado", _obj.Resultado, ParameterDirection.Input);
            AddCmdParameter("@Estado_Aprobacion", _obj.Estado_Aprobacion, ParameterDirection.Input);
        }
    }
}
