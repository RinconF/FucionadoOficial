...
namespace DAL
{
    public class Int_06_EVA_Ingreso_EvaluacionFactory : FactoryBase
    {
        public Int_06_EVA_Ingreso_EvaluacionFactory() { }

        //public Int_01_EVA_Evaluaciones Load(Int_01_EVA_Evaluaciones _obj)
        //{
        //    try
        //    {
        //        AddParameters(_obj);
        ...
        //public Int_06_EVA_Ingreso_EvaluacionCollection SelectByParams(Int_01_EVA_Evaluaciones _obj, int Action)
        //{
        //    Int_06_EVA_Ingreso_EvaluacionCollection Collection = new Int_06_EVA_Ingreso_EvaluacionCollection();
        //    try
        //    {
        //        AddParameters(_obj);
        ...
        {
            CreateCommand("Int_06_EVA_Ingreso_Evaluacion_SP", true);
